...
namespace Zork
{
    class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            roomMap["South of House"].Description = "You are facing the south side of a white house. There is no door here, and all windows are barred.";             //South of House
            roomMap["Canyon View"].Description = "You are at the top of the Great anyon in its south wall.";                                                       //Canyon View
            ...
            roomMap["Dense Woods"].Description = "This is a dimly lit forest, with large trees allaround. To the east, there appears to be sunlight.";             //Dense Woods
